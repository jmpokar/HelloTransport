								...
								<c:choose>
									<c:when test="${Carpooler ne null}">
										<div id="container">
											...
											<%@include file="carpoolSettings/carpoolerDateSelectionOptionsUpdate.jsp" %>
											<!-- CARPOOLER START AND END DATE END -->
						
											<!-- CARPOOLER START AND END TIMING DETAILS START -->
											<%@include file="carpoolSettings/carpoolerSourceToDestinationRouteOptionUpdate.jsp" %>
											<!-- CARPOOLER START AND END TIMING DETAILS END -->
						   
											<!-- CARPOOLER RETURN ROUTE DETAILS START -->
											<%@include file="carpoolSettings/carpoolerReturnRouteOptionUpdate.jsp" %>
											<!-- CARPOOLER RETURN ROUTE DETAILS END -->
											
											<!-- CARPOOLER PREFERENCE START -->
											<%@include file="carpoolSettings/carpoolerPreferenceUpdate.jsp" %>
