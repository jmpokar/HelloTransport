							...
							<div id="page">	    
								<div id="container">
									...
									<table width="100%" style="margin: 10px 10px 10px 10px;" border="0">
										<tr>
											<c:choose>
												<c:when test="${ ( fn:contains(user.userProfilePic , 'resources/common/images/profilePicture/male.jpg') or fn:contains(user.userProfilePic , 'resources/common/images/profilePicture/female.jpg') ) }">
									...
									<table width="100%" style="margin: 10px 10px 10px 10px;" border="0">
										...
										<tr>
											<c:choose>
												<c:when test="${not (fn:contains(user.userProfilePic , 'resources/common/images/profilePicture/male.jpg') or fn:contains(user.userProfilePic , 'resources/common/images/profilePicture/female.jpg') ) }">
													<td>
														<center>
