...
<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
    ...
    <div>
        <img u=image src="../../resources/transport/images/imageSliderAtTestimonialPage/a.JPG" />
        <div u="thumb"></div>
    </div>
    <div>
        <img u=image src="../../resources/transport/images/imageSliderAtTestimonialPage/b.JPG" />
        <div u="thumb"></div>
    </div>
    <div>
        <img u=image src="../../resources/transport/images/imageSliderAtTestimonialPage/c.jpg" />
        <div u="thumb"></div>
    </div>
    <div>
        <img u=image src="../../resources/transport/images/imageSliderAtTestimonialPage/d.gif" />
        <div u="thumb"></div>
    </div>
    <div>
        <img u=image src="../../resources/transport/images/imageSliderAtTestimonialPage/e.png" />
        <div u="thumb"></div>
    </div>
